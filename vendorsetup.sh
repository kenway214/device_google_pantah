...
git clone https://github.com/kenway214/device_google_gs201.git -b crdroid-14 device/google/gs201
git clone https://github.com/kenway214/device_google_gs101.git -b crdroid-14 device/google/gs101
