...
git clone https://github.com/kenway214/device_google_gs201.git -b blaze-14-pb device/google/gs201
git clone https://github.com/kenway214/device_google_gs101.git -b blaze-14-pb device/google/gs101
git clone https://github.com/kenway214/device_google_gs-common.git -b derp-14 device/google/gs-common

# Kernel
echo 'Cloning kernel tree'
git clone --branch android-14.0.0_r22 --depth 1 https://android.googlesource.com/device/google/pantah-kernel device/google/pantah-kernel
