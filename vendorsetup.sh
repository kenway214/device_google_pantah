...
git clone https://github.com/kenway214/device_google_gs201.git -b banana-14 device/google/gs201
git clone https://github.com/kenway214/device_google_gs101.git -b banana-14 device/google/gs101
...
rm -rf system/core/ && git clone https://github.com/banana-cheetah/banana_android_system_core/ -b 14 system/core/

rm -rf device/banana/sepolicy && git clone https://github.com/banana-cheetah/banana_device_banana_sepolicy/ -b 14-pixel device/banana/sepolicy
