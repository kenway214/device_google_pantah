...
git clone https://github.com/kenway214/device_google_gs201.git -b lineage-21 device/google/gs201
git clone https://github.com/kenway214/device_google_gs101.git -b lineage-21 device/google/gs101
git clone https://github.com/kenway214/device_google_gs-common.git -b lineage-21 device/google/gs-common
...
git clone https://github.com/TheMuppets/proprietary_vendor_google_cheetah.git -b lineage-21 vendor/google/cheetah
