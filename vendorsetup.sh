...
git clone https://github.com/kenway214/device_google_gs201.git -b superior-14 device/google/gs201
git clone https://github.com/kenway214/device_google_gs101.git -b superior-14 device/google/gs101
...
# BCR
echo 'Cloning bcr'
git clone --depth=1 https://github.com/Evolution-X/vendor_bcr.git -b main vendor/bcr
...
rm -rf system/core && git clone https://github.com/banana-cheetah/superiorext_system_core -b UDC system/core
